...
CREATE TABLE `attachment` (
  ...
  CONSTRAINT `attachment_ibfk_2` FOREIGN KEY (`postNum`) REFERENCES `post` (`postNum`),
  CONSTRAINT `attachment_ibfk_3` FOREIGN KEY (`postNum`) REFERENCES `post` (`postNum`),
  CONSTRAINT `FK_PostAttached` FOREIGN KEY (`postNum`) REFERENCES `post` (`postNum`)
...
CREATE TABLE `comment` (
  ...
  KEY `eventID` (`eventID`),
  KEY `userID` (`userID`),
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`postNum`) REFERENCES `post` (`postNum`),
...
CREATE TABLE `recommend` (
  ...
  KEY `postNum` (`postNum`),
  CONSTRAINT `recommend_ibfk_1` FOREIGN KEY (`postNum`) REFERENCES `post` (`postNum`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
